...
namespace Chocopoi.DressingTools.Tests.Passes.Modifiers
{
    internal class ArmatureMappingPassTest : EditorTestBase
    {
        ...
        public void MapOverrideTest()
        {
            ...
            overrideTag.CopyDynamicsConfig.TargetPath = "Armature/Hips/MyDynBone";
            ...
            Assert.AreEqual(DTCopyDynamics.DynamicsSearchMode.ControlRoot, copyDynComp.SearchMode);
            Assert.AreEqual("Armature/Hips/MyDynBone", copyDynComp.SearchPath);
        }
        ...
        public void MapManualTest()
        {
            ...
            newTag.CopyDynamicsConfig.TargetPath = "Armature/Hips/MyDynBone";
