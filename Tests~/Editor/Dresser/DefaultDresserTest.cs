...
namespace Chocopoi.DressingTools.Tests.Dresser
{
    internal class DefaultDresserTest : EditorTestBase
    {
        ...
        private static ITag[] ExpectedIgnoreTransformTags(Transform wearableRoot)
        {
            return new ITag[] {
                new IgnoreDynamicsTag() { SourceTransform = wearableRoot.Find("Armature/Hips/MyDynBone") },
                new IgnoreDynamicsTag() { SourceTransform = wearableRoot.Find("Armature/Hips/MyDynBone/MyDynBone1") },
                new IgnoreDynamicsTag() { SourceTransform = wearableRoot.Find("Armature/Hips/MyDynBone/MyDynBone2") },
                new IgnoreDynamicsTag() { SourceTransform = wearableRoot.Find("Armature/Hips/MyAnotherDynBone") },
                new IgnoreDynamicsTag() { SourceTransform = wearableRoot.Find("Armature/Hips/MyAnotherDynBone/MyAnotherDynBone1") },
                new IgnoreDynamicsTag() { SourceTransform = wearableRoot.Find("Armature/Hips/MyAnotherDynBone/MyAnotherDynBone2") }
            };
        }
        ...
        private void AvatarDynamics_IgnoreTransform_ReturnsCorrectBoneMappingAndLogCodes(GameObject avatarRoot, GameObject wearableRoot)
        {
            ...
            var expectedTags = ExpectedIgnoreTransformTags(wearableRoot.transform);
            Assert.AreEqual(expectedMappings.Length, objectMappings.Count, "Bone mapping length is not equal to expected length");
