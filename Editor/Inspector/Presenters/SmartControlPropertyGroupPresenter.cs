...
namespace Chocopoi.DressingTools.UI.Presenters
{
    internal class SmartControlPropertyGroupPresenter
    {
        ...
        private void SearchComponents()
        {
            ...
            var searchObjs = SmartControlUtils.GetSelectedObjects(_view.PickFromTransform, _view.Target.GameObjects, _view.Target.SelectionType == DTSmartControl.PropertyGroup.PropertySelectionType.Inverted);
            foreach (var searchObj in searchObjs)
            {
                var comps = searchObj.GetComponentsInChildren<Component>();
