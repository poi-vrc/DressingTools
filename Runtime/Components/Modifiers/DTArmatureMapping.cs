...
namespace Chocopoi.DressingTools.Components.Modifiers
{
    ...
    internal class DTArmatureMapping : DTBaseComponent
    {
        ...
        public class Tag
        {
            ...
            public TagCopyDynamicsConfig CopyDynamicsConfig { get => m_CopyDynamicsConfig; set => m_CopyDynamicsConfig = value; }

            [SerializeField] private TagType m_Type;
            [SerializeField] private Transform m_SourceTransform;
            [SerializeField] private TagCopyDynamicsConfig m_CopyDynamicsConfig;

            public Tag()
            {
                m_Type = TagType.IgnoreTransform;
                m_SourceTransform = null;
                m_CopyDynamicsConfig = new TagCopyDynamicsConfig();
            }

            public override string ToString()
            {
                return $"{m_Type}: {m_SourceTransform.name}";
            }
        }
