...
namespace Chocopoi.DressingTools.Lib.Serialization
{
    ...
    {
        public abstract SerializationVersion Version { get; set; }

        public abstract ISerializer GetSerializerByVersion(SerializationVersion version);
        ...
        public virtual void DeserializeFrom(JObject jObject)
        {
            ...
            var moduleVersion = jObject.ContainsKey("version") ?
                new SerializationVersion(jObject["version"].Value<string>()) :
                null;
